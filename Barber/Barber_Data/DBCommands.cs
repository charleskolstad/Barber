...
namespace Barber_Data
{
    public class DBCommands
    {
        ...
        public readonly static string _Connection = @"Data Source=DESKTOP-O4M7D2C\CHARLESSERVER;Initial Catalog=BarberThree;Integrated Security=True";
